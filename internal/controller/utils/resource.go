...
import (
	"bytes"
	"github.com/EchoGroot/kubebuilder-demo/api/v1beta1"
...
func parseTemplate(templateName string, app *v1beta1.App) []byte {
	tmpl, err := template.ParseFiles("/Users/xxx/workspace/personal/k8s/kubebuilder-demo/internal/controller/template/" + templateName + ".yml")
	if err != nil {
		panic(err)
	}
	b := new(bytes.Buffer)
